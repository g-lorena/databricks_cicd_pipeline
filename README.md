...
The 'databrick_cicd_pipeline' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databrick_cicd_pipeline_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/databrick_cicd_pipeline.job.yml). The schedule
